...
(* analyse_placement_instruction : AstType.bloc -> int -> string -> AstPlacement.bloc -> int *)
(* Paramètre dep : le deplacement à utiliser *)
(* Paramètre reg : registre utiliser *)
(* Paramètre li : le bloc à analyser *)
(* transformation du bloc après vérification de son placement mémoire 
...
(* Vérification du placement mémoire de la fonction et tranforme la fonction
...
(* Vérification du placement mémoire et tranformation du programme
